...
<head>
  ...
  <link rel="stylesheet" href="<?= BASEURL; ?>/css/404-style.css">
...
<body>
  ...
  <div class="notfound-copy">
    ...
    <p><a href="<?= BASEURL; ?>">Kembali ke Beranda <strong><?= SHOP; ?></strong></a></p>
  </div>
  ...
  <script src="<?= BASEURL; ?>/js/404-script.js"></script>
</body>

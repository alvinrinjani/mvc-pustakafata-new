                ...
                <?php foreach ($data['buku_hemat'] as $b_hemat) : ?>
                  <div class="col-lg-4 col mb-4">
                    <div class="card border-bottom-info h-100">
                      <a href="<?= BASEURL; ?>/koleksibuku/detailbukuhemat/<?= $b_hemat['slug']; ?>"><img src="<?= BASEURL . '/img/' . $b_hemat['gambar']; ?>" class="card-img-top" alt="<?= $b_hemat['slug']; ?>"></a>
                      <div class="card-body">
                      </div>
                      <a href="<?= BASEURL; ?>/koleksibuku/detailbukuhemat/<?= $b_hemat['slug']; ?>" class="card-title text-center merienda mb-5"><?= $b_hemat['judul']; ?></a>
                ...
                <?php foreach ($data['buku_anak'] as $b_anak) : ?>
                  <div class="col-lg-4 col mb-4">
                    <div class="card border-bottom-warning h-100">
                      <a href="<?= BASEURL; ?>/koleksibuku/detailbukuanak/<?= $b_anak['slug']; ?>"><img src="<?= BASEURL . '/img/' . $b_anak['gambar']; ?>" class="card-img-top" alt="<?= $b_anak['slug']; ?>"></a>
                      <div class="card-body">
                      </div>
                      <a href="<?= BASEURL; ?>/koleksibuku/detailbukuanak/<?= $b_anak['slug']; ?>" class="card-title text-center merienda mb-5"><?= $b_anak['judul']; ?></a>
                ...
                <?php foreach ($data['buku_pemikiran'] as $b_pemikiran) : ?>
                  <div class="col-lg-4 col mb-4">
                    <div class="card border-bottom-danger h-100">
                      <a href="<?= BASEURL; ?>/koleksibuku/detailbukupemikiran/<?= $b_pemikiran['slug']; ?>"><img src="<?= BASEURL . '/img/' . $b_pemikiran['gambar']; ?>" class="card-img-top" alt="<?= $b_pemikiran['slug']; ?>"></a>
                      <div class="card-body">
                      </div>
                      <a href="<?= BASEURL; ?>/koleksibuku/detailbukupemikiran/<?= $b_pemikiran['slug']; ?>" class="card-title text-center merienda mb-5"><?= $b_pemikiran['judul']; ?></a>
                ...
                <?php foreach ($data['buku_umum'] as $b_umum) : ?>
                  <div class="col-lg-4 col mb-4">
                    <div class="card border-bottom-primary h-100">
                      <a href="<?= BASEURL; ?>/koleksibuku/detailbukuumum/<?= $b_umum['slug']; ?>"><img src="<?= BASEURL . '/img/' . $b_umum['gambar']; ?>" class="card-img-top" alt="<?= $b_umum['slug']; ?>"></a>
                      <div class="card-body">
                      </div>
                      <a href="<?= BASEURL; ?>/koleksibuku/detailbukuumum/<?= $b_umum['slug']; ?>" class="card-title text-center merienda mb-5"><?= $b_umum['judul']; ?></a>
